...
export function getViewport(diagram: DiagramIR) {
...
export function getDiagramLanes(diagram: DiagramIR): DiagramLane[] {
...
export function toExcalidrawInitialData(diagram: DiagramIR): ExcalidrawInitialDataState {
...
export function diagramLabel(diagram: DiagramIR) {
