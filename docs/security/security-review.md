...
- **位置**: `apps/api/src/middleware/auth.ts:76-103`
...
- **位置**: `services/rag/app/main.py:11-21`, `services/rag/app/api/routes.py:14-15`
...
- **位置**: `apps/api/src/server.ts:21`, `services/rag/app/main.py:13-19`
- **风险**:
...
- **位置**: `apps/api/src/routes/health.ts:6`, `apps/api/src/routes/admin.ts:12`
- **风险**:
...
- **位置**: `apps/api/src/server.ts:18-42`（中间件注册处无 rate-limit）
...
- **位置**: `services/rag/app/api/routes.py:31-43`, `services/rag/app/core/pipeline.py:33-38`
...
- **位置**: `services/rag/app/api/routes.py:40,42-43,56,58-59,74,89-90,106`
...
- **位置**: `apps/api/src/server.ts:18-42`（全应用）
...
- **位置**: `services/rag/app/core/pipeline.py:102-145`, `apps/api/src/routes/search.ts:43-75`
...
- **位置**: `apps/api/src/routes/documents.ts:60-68`
...
- **位置**: `apps/api/src/routes/documents.ts:116-204`
...
- **位置**: `apps/api/src/services/auditService.ts:39-41`
...
- **位置**: `apps/api/src/db/chatMessages.ts`, `apps/api/src/db/index.ts:110-128`
...
- **位置**: `apps/api/src/server.ts:18-42`
...
- **位置**: `services/rag/app/api/routes.py:18-27`
...
- **位置**: `apps/api/src/middleware/auth.ts:89-99`
...
- **位置**: `apps/api/src/routes/chat.ts:17`
...
- **位置**: `apps/api/package.json`, `apps/web/package.json`, `services/rag/pyproject.toml`
