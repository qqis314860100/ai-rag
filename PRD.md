...
- API 侧的消息分支截断、source detail 契约和文档预览契约已完成；仍需补齐笔记能力归属和 RAG metadata 增强。
...
1. 先做 `api` 评估笔记能力的数据归属，确定会话笔记、回答笔记、引用笔记是否需要独立表。
2. 然后做 `rag` metadata 扩展，让引用详情和多格式预览有真实数据支撑。
